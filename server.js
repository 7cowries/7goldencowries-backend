...
// Render-safe: preflight DB + idempotent migrations + SAFE getSubStatus fallback.
...
// ensure subscriptions table exists (base shape)
await predb.exec(`
...
// add columns defensively (no-op if already exist)
for (const stmt of [
  ...
  try { await predb.exec(stmt); } catch {}
}
...
// ─────────────────────────────────────────────────────────────
// 1) import the real DB connection
...
// SUBSCRIPTIONS helpers (SAFE: fallback if 'active' column does not exist)
...
async function getSubStatus(wallet){
  ...
  try {
    ...
    // graceful downgrade when column doesn't exist
...
// routes
const app2 = app;
app2.use("/api/leaderboard", (await import("./routes/leaderboard.js")).default);
app2.use("/api/v1/leaderboard", (await import("./routes/leaderboard.js")).default);
app2.use("/api/quests", (await import("./routes/quests.js")).default);
app2.use("/api/v1/quests", (await import("./routes/quests.js")).default);
app2.use("/api/referrals", (await import("./routes/referrals.js")).default);
app2.use("/api/v1/referrals", (await import("./routes/referrals.js")).default);
app2.use("/api/twitter", (await import("./routes/twitterVerify.js")).default);
