...
const SQLITE_TARGET = String(process.env.SQLITE_FILE || "").trim();
const IS_TEST = process.env.NODE_ENV === "test";
const ALLOW_SQLITE_TEST_RUNTIME = IS_TEST && Boolean(SQLITE_TARGET);
...
const db = ALLOW_SQLITE_TEST_RUNTIME ? await createSqliteDb() : await createPostgresDb();
db.dialect = ALLOW_SQLITE_TEST_RUNTIME ? "sqlite" : "postgres";
